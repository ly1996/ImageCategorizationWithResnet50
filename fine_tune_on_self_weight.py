...
LOG_DIR = os.path.expanduser('~/Disk/logs/resnet50/6')
MODEL_FILE_PATH = os.path.expanduser('~/Disk/models/resnet50/6/checkpoint-{epoch:02d}-{val_loss:.4f}.hdf5')   # 模型Log文件以及.h5模型文件存放地址
...
def main():
    ...
    model_file = os.path.expanduser("~/Disk/models/resnet50/5/checkpoint-48-0.5055.hdf5")
    output_model_file = os.path.expanduser("~/Disk/models/resnet50/6/model.hdf5")
    Width = 224
    Height = 224
