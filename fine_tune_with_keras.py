...
LOG_DIR = os.path.expanduser('~/Disk/logs/resnet50/7')
MODEL_FILE_PATH = os.path.expanduser('~/Disk/models/resnet50/7/checkpoint-{epoch:02d}-{val_loss:.4f}.hdf5')   # 模型Log文件以及.h5模型文件存放地址
...
def main():
    ...
    output_model_file = os.path.expanduser("~/Disk/models/resnet50/7/model.h5")
    Width = 224
    Height = 224
